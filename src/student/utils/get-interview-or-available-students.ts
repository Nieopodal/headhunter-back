...
export const getInterviewOrAvailableStudents = async (filterSchema: FilterStudentDto | undefined, pageNumber: number, numberPerPage: number, hrId: string, status: StudentStatus, name: string) => {
